...
from .mars_models import (
    MarsPhotosResponse, ManifestResponse, RoverName, ROVER_CAMERAS
)
...
class MarsRoverPhotosClient(NASAClient):
    ...
    def get_photos_by_earth_date(
        ...
        Returns:
            MarsPhotosResponse containing photos
        """
        return self.get_photos(rover=rover, earth_date=earth_date, camera=camera, page=page)
